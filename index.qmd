...
## What can you do with Nanopubs? {.smaller}

Construct knowledgegraphs for your paper!

. . .

![Example knowledgefrage for a data analysis workflow (which nanopub IDs)](images/Snakemake_Metadata.png)

Created with [the Snakemake reporter plugin for posting workflow metadata](https://github.com/snakemake/snakemake-report-plugin-nanopub/).
...
![https://scholia.toolforge.org/cito/](images/CiTO_Scholia.png)

::: {.callout-tip}
# Nanopub has a Template for your CiTOs

[Declare CiTOs with this template](https://w3id.org/np/RAX_4tWTyjFpO6nz63s14ucuejd64t2mK3IBlkwZ7jjLo).
:::
